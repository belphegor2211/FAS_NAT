...
from .resnet_lgt import ResNet, BasicBlock
...
class ResNetNAT(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.patch_embed = ResNet(
            BasicBlock, [2, 2, 2, 2], num_classes, self.embed_dim, True, False, False
        )
